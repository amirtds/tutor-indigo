...
config: t.Dict[str, t.Dict[str, t.Any]] = {
    ...
    "defaults": {
        "VERSION": __version__,
        "WELCOME_MESSAGE": "Welcome to Metaprotv, the place for all your online learning",
...
hooks.Filters.ENV_PATCHES.add_items(
    [
        ...
        (
            ...
            """
RUN npm install '@edx/brand@git+https://github.com/amirtds/brand-openedx.git#bf6c1b6c130e6098150beed43fa1ed2d74042a1d'
